    ...
    %>
        ...
        function initTable(){
            ...
            var temp = {
                ...
                columns: [
                    {checkbox: true},
                    {field : 'saleOrderDetailId', title : '销售订单编号', align : 'center', valign : 'middle', sortable : true},
                    ...
                    {field : 'money', title : '商品总价', align : 'center', valign : 'middle'},
                    {field : 'num', title : '商品个数', align : 'center', valign : 'middle'},
                    {field : 'price', title : '商品价格', align : 'center', valign : 'middle'},
                    {field : 'state', title : '出库状态', align : 'center', valign : 'middle'},
                    {field : 'sale', title : '销售员', align : 'center', valign : 'middle'},
                    {field : 'saleId', title : '销售员编号', align : 'center', valign : 'middle'},
                    {field : 'op', title : '操作', align : 'center', valign : 'middle',
                        formatter : function (value, row, index){
                            var temp = "<a href='#' onclick='upSave(\""+row.saleOrderDetailId+"\")'>编辑</a>";
                            temp += "&nbsp;&nbsp;<a href='#' onclick='deleteSave(\""+row.saleOrderDetailId+"\")'>删除</a>";
                            return temp;
