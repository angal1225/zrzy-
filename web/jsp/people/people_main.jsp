...
<script type="text/javascript">
		...
		function initTable(){
			...
			var temp = {
		        ...
		        columns: [
		                  	{checkbox: true},
	                  		{field : 'people_id', title : '人员编码', align : 'center', valign : 'middle', sortable : true},
	                  		{field : 'people_name', title : '人员姓名', align : 'center', valign : 'middle', sortable : true},
	                  		{field : 'people_sex', title : '人员性别', align : 'center', valign : 'middle', sortable : true},
	                  		{field : 'people_age', title : '人员年龄', align : 'center', valign : 'middle'},
	                  		{field : 'people_phone', title : '联系电话', align : 'center', valign : 'middle'},
